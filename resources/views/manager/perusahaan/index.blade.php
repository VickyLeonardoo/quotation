            ...
            <div class="card full-height">
                <div class="card-body">
                    <div class="container-fluid">
                        <a href="{{ url('manager/perusahaan/create') }}" class="btn btn-info">Tambah</a>
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manager.perusahaan.edit',$perusahaan->slug) }}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i>Edit</a>
                ...
                swal({
                    ...
                    if (willDelete) {
                        window.location.href =
                            '{{ route('manager.perusahaan.delete', ['id' => $perusahaan->id]) }}';
                    }
                });
            });
        @endforeach
