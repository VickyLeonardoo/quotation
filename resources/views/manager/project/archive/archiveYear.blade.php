...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card full-height">
            <div class="card-body">
                <form action="{{ url('/manager/quotation/archive/'.$year) }}">
                    @csrf
                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manager.project.ongoing.edit',$pro->id) }}" title="Quotation" class="btn btn-info"><i class="fas fa-file-invoice"></i></a>
                                </td>
                            </tr>
                            @endforeach
