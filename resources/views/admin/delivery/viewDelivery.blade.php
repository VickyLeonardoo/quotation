...
@section('title', Route::is('admin.delivery.draft') ? 'Delivery Draft' : 'Delivery Confirmed')
            ...
            <div class="card full-height">
                <div class="card-body">
                    <div class="container-fluid">
                        <a href="{{ url('admin/delivery-draft/create') }}" class="btn btn-info">Tambah</a>
                ...
                swal({
                    ...
                    if (willDelete) {
                        window.location.href =
                            '{{ route('admin.delivery.draft.delete', ['id' => $delivery->id]) }}';
                    }
                });
            });
        @endforeach
