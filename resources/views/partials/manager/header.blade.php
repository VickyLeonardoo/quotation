...
<body data-background-color="bg2">
			...
			<div class="container-fluid">
				<nav class="navbar navbar-line navbar-header-left navbar-expand-lg p-0  d-none d-lg-flex">
					<ul class="navbar-nav page-navigation page-navigation-info">
						...
						<li class="nav-item {{ Route::is('manager.quotation*') ? 'active':''}}">
							<a class="nav-link" href="{{ url('manager/quotation') }}">
								Quotation
							</a>
						</li>
						<li class="nav-item {{ Route::is('manager.invoice*') ? 'active':''}}">
							<a class="nav-link" href="{{ url('manager/invoice') }}">
								Invoice
							</a>
						</li>
                        <li class="nav-item {{ Route::is('manager.project*') ? 'active':''}}">
							<a class="nav-link" href="{{ url('manager/project') }}">
								Project
							</a>
						</li>
						<li class="nav-item {{ Route::is('manager.delivery*') ? 'active':''}}">
							<a class="nav-link" href="{{ url('manager/delivery') }}">
								Delivery Order
							</a>
						</li>
                        {{-- <li class="nav-item">
	...
	<!--   Core JS Files   -->
	@include('partials.manager.script')
</body>
</html>
